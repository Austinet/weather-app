...
const Home = () => {
  ...
  // Gets the weather overcast for cities
  ...
  //search for the weather overcast of a city
  ...
  //Update the city weather and routes to the city's page
  ...
  return (
    <div className={`${weatherBG} bg-cover no-repeat min-h-screen`}>
